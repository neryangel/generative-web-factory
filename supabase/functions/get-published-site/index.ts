...
import { getPublicCorsHeaders, handleCorsPreflightRequest } from "../_shared/cors.ts";

// Public endpoint - allows any origin since published sites can be embedded anywhere
